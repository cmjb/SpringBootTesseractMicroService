...
@Service
public class UploadedFileService implements IStorageService {

    private final Path rootLocation;

    @Autowired
    public UploadedFileService(StorageProperties properties) {
    ...
    public Path store(MultipartFile file) {
        try {
            ...
            throw new BaseException("Failed to store file.", e);
        }
    }
